class Hash
  ...
  #
  # @param user_id_or_screen_name [Integer, String] A Manybots user ID or screen_name.
  # @return [Hash]
  ...
  #
  # @param users_id_or_screen_names [Array] An array of Manybots user IDs or screen_names.
  # @return [Hash]
  ...
  # (for Manybots API endpoints that want :owner_id and :owner_screen_name)
  #
  # @param owner_id_or_owner_screen_name [Integer, String] A Manybots user ID or screen_name.
  # @return [Hash]
  ...
  #
  # @param list_id_or_slug [Integer, String] A Manybots list ID or slug.
  # @return [Hash]
